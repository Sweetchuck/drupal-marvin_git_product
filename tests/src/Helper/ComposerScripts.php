...
namespace Drupal\Tests\marvin_git_product\Helper;
...
class ComposerScripts {
  ...
  protected function prepareProjectComposerJson() {
    $content = [
      'name' => 'drupal/marvin-git-product-tests-project_01',
      'description' => 'drupal/marvin-git-product-tests-project_01',
      "license" => "proprietary",
      'type' => 'drupal-project',
      'extra' => [
        'installer-types' => [
...
TEXT;
  ...
  protected function getProjectSelfFilesToSymlink(): array {
    ...
    $filesToSymLink = $extra['marvin_git_product']['fixtures']['filesToSymlink'] ?? [];
